...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8("icons/beenden.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8("icons/speichern.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actionSpeichern->setIcon(icon1);
        actionEinlesen = new QAction(MainWindow);
        actionEinlesen->setObjectName("actionEinlesen");
        QIcon icon2;
        icon2.addFile(QString::fromUtf8("icons/einlesen.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8("icons/drache.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8("icons/reiseplan.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8("icons/drachenreise.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8("icons/passagier.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8("icons/suchen.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
